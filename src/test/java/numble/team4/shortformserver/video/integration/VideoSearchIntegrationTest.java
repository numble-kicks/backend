...
class VideoSearchIntegrationTest {
    ...
    void findByKeyword() {
        ...
        // when
        List<VideosResponse> res = videoSearchController.searchByKeyword(new VideoSearchRequest(keyword, null, null))
            .getData();
    ...
    void findByKey_sortById() {
        ...
        // when
        List<VideosResponse> data = videoSearchController.searchByKeyword(new VideoSearchRequest(keyword, ids.get(10), null)).getData();
    ...
    void findByKeyword_sortByHits() {
        ...
        // when
        List<VideosResponse> lastId가_null = videoSearchController.searchByKeyword(new VideoSearchRequest(keyword, null, "hits")).getData();
    ...
    void findByKeyword_sortByHits_cursor() {
        ...
        // when
        List<VideosResponse> lastId는8 = videoSearchController.searchByKeyword(new VideoSearchRequest(keyword, ids.get(7), "hits")).getData();
    ...
    void findByKeyword_cursor_id_exist() {
        ...
        // when
        List<VideosResponse> 정렬_순서_325 = videoSearchController.searchByKeyword(new VideoSearchRequest(keyword, null, "hits")).getData();
    ...
    void getVideoTop10() {
        ...
        // when
        List<VideosResponse> hits = videoSearchController.getTopVideo(new VideoListRequest("hits", 10)).getData();
        List<VideosResponse> likes = videoSearchController.getTopVideo(new VideoListRequest("likes", 10)).getData();
